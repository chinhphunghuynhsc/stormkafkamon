...
def read_args():
    parser = argparse.ArgumentParser(
        description='Show complete state of Trident-Kafka consumers')
    ...
    parser.add_argument('--spout', type=str, required=True,
        help='Storm Topology')
    parser.add_argument('--transactionroot', type=str, default='/transactional',
        help='Storm Topology')
...
def main():
    ...
    try:
        print zc.transactions(options.transactionroot, options.spout)
